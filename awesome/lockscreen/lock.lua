...
local clock = wibox.widget{
    help.vertical_pad(120),
    {
        font = beautiful.font .. "Medium 82",
        format = help.fg("%H", beautiful.fg),
...
local wrong_password = wibox.widget{
    widget = wibox.widget.textbox,
    markup = "<span foreground='" .. beautiful.err .. "'>Password Incorrect!</span>",
    font = beautiful.font .. "Light 14",
    align = "center",
    valign = "center",
    visible = false,
}
...
local function fail()
    ...
    lock_animation_widget_rotate.direction = "north"
    pfp_overlay.bg = beautiful.err .. "1A"
    icon.markup = "<span foreground='" .. beautiful.err .. "'>" .. lock_screen_fail_symbol .. "</span>"
    lock_animation_arc.bg = "#00000000"
end
...
local function key_animation(char_inserted)
    ...
    if char_inserted then
        ...
        if characters_entered == 0 then
            ...
            color = beautiful.err .. "55"
        end
    end

    lock_animation_arc.bg = color
    icon.markup = "<span foreground='" .. beautiful.fg .. "'>" .. lock_screen_symbol .. "</span>"
